...
def build_system_prompt(
    ...
    lines.append("· Respond conversationally — plain sentences, no markdown. No ### headers, no **bold**, no bullet lists unless James explicitly asks for a list or document. If you need to share specs or a comparison, write it as natural prose or a simple readable layout, not a formatted document.")
